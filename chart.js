...
!(function () {
 ...
 const t = {
   ...
   e = {
     ...
     topFillColor1: "rgba(48, 188, 49, 0.38)",
     topFillColor2: "rgba(48, 188, 49, 0.38)",
     topLineColor: "rgba(48, 188, 49, 0.38)",
     bottomFillColor1: "rgba(48, 188, 49, 0.38)",
     bottomFillColor2: "rgba(48, 188, 49, 0.38)",
     bottomLineColor: "rgba(48, 188, 49, 0.38)",
     lineWidth: 3,
     lineStyle: 0,
     lineType: 0,
     lineVisible: !0,
   ...
   Mt() {
     ...
     i.forEach((i, e) => {
       ...
       (h.lt = l.Tt),
         ...
         (h.rt =
           null !== (r = l.At) && void 0 !== r
             ? r
             : this.F.Bt(h.it[0].st / i.Dt().Vt())),
         (h.it[0].ot = n),
         (h.it[0].nt = s.zt(n)),
         (h.tt = W);
     });
 ...
 function K(t, i, n, s, e, r, h = 0, l = [0, 0, 0, 0], a = "") {
   if ((t.save(), !h || !a || a === r))
     return X(t, i, n, s, e, l), (t.fillStyle = r), t.fill(), void t.restore();
   const o = h / 2;
   if ("transparent" !== r) {
     X(t, i + h, n + h, s - 2 * h, e - 2 * h, Y(l, -h)),
       (t.fillStyle = r),
       t.fill();
   }
   if ("transparent" !== a) {
     X(t, i + o, n + o, s - h, e - h, Y(l, -o)),
       (t.lineWidth = h),
       (t.strokeStyle = a),
       t.closePath(),
       t.stroke();
     ...
     const e = this.Et.O,
       ...
       h = t.useBitmapCoordinateSpace((t) => {
         ...
         const l = this.Gt(t, i, n, s),
           ...
           o = (t, i) => {
             l.Qt
               ? K(h, a.ti, a.ii, a.ni, a.si, t, a.ei, [a.ht, 0, 0, a.ht], i)
               : K(h, a.ri, a.ii, a.ni, a.si, t, a.ei, [0, a.ht, a.ht, 0], i);
           };
         return (
           o(r, "transparent"),
           this.Et.hi &&
 ...
 class J {
   constructor(t) {
     (this.yi = { Si: 0, t: "#000", wi: 0, bi: 0 }),
       ...
       (this.ft = !0),
       (this.Ti = new (t || G)(this.ki, this.yi)),
 ...
 class _t {
   ...
   rs(t) {
     ...
     if (i > 1) {
       ...
       r >= i && ((r -= i), (n += 1)),
         (s = at + ot(+r.toFixed(this.hs) * this.ss, e));
 ...
 class wt extends L {
   ...
   Z(t) {
     ...
     (o.lineCap = "butt"),
       ...
       _(o, h),
       (o.lineWidth = 1),
       dt(t, n, l, s, e, this.fs.bind(this), bt.bind(null, a));
   }
 }
 function gt(t, i, n) {
 ...
 class Vt {
   ...
   Us() {
     ...
     const s = this.zs.Ct();
     null !== s &&
       ((this.Vs = Bt(this.Bs, n, this.Is)), this.Xs(t, i, s.Ot), this.Ks());
   }
 }
 class zt extends Vt {
   constructor(t, i) {
 ...
 class It extends L {
   ...
   Z({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
     if (null === this.Et || 0 === this.Et.Bn.length || null === this.Et.tt)
       return;
 ...
 class qt extends Vt {
   constructor(t, i, n) {
     super(t, i, !1),
       (this.mn = n),
       (this.Ns = new Ut(this.mn.renderer(), (i) => {
         const n = t.Ct();
 ...
 const ri = [
   { Pr: 0, Rr: 0.25, Dr: 4, Or: 10, Ar: 0.25, Br: 0, Vr: 0.4, zr: 0.8 },
   { Pr: 0.25, Rr: 0.525, Dr: 10, Or: 14, Ar: 0, Br: 0, Vr: 0.8, zr: 0 },
   { Pr: 0.525, Rr: 1, Dr: 14, Or: 14, Ar: 0, Br: 0, Vr: 0, zr: 0 },
 ];
 function hi(t, i, n, s) {
   return (function (t, i) {
 ...
 class xi extends J {
   ...
   zi(t, i, n) {
     ...
     const e = s.W(),
       ...
       a = s.Ur(!1);
     if (a.qr) return;
     r && ((t.Zt = this.uh(a, r, l)), (t.kt = 0 !== t.Zt.length)),
       (h || l) && ((i.Zt = this.dh(a, r, h, l)), (i.kt = i.Zt.length > 0));
     const o = s.oh(a.O),
       _ = y(o);
     (n.t = _.t),
       (n.Si = a.Si),
       (i.At = s.$t().Bt(a.Si / s.Dt().Vt())),
       (t.At = o),
       (t.O = _.i),
       (i.O = _.i);
   }
 ...
 class yi {
   ...
   Jn(t) {
     return null === t
       ? this
       : new yi(
           Si(Math.min, this.xh(), t.xh(), -1 / 0),
           Si(Math.max, this.Sh(), t.Sh(), 1 / 0)
         );
   }
   kh(t) {
     if (!T(t)) return;
 ...
 class Ti extends J {
   ...
   zi(t, i, n) {
     ...
     r && ((i.Zt = s.title), (i.kt = !0)),
       (i.At = h.$t().Bt(l / h.Dt().Vt())),
       (t.Zt = this.zh(s.price)),
       (t.kt = !0);
 ...
 class Pi {
   constructor(t, i) {
     (this.Nr = t),
       (this._n = i),
       (this.Eh = new Ci(t, this)),
       (this.lr = new Ti(t, this)),
       (this.Ih = new ti(this.lr, t, t.$t()));
   }
   Lh(t) {
 ...
 class Oi {
   constructor(t) {
     (this.$h = (t, i) => (void 0 !== i ? i.Ot : this.Nr.Bn().Uh(t))),
       (this.Nr = t),
       (this.qh = Di[t.Yh()]);
   }
   Ws(t, i) {
 ...
 class Vi {
   ...
   il(t, i = 0) {
     ...
     return null === n
       ? null
       : Object.assign(Object.assign({}, this.nl(n)), { ie: this.Qh(n) });
   }
   Qs() {
     return this.Xh;
   }
 ...
 class Ii {
   ...
   gt() {
     ...
     if (null === i) return null;
     if ((null === (t = this.Ge) || void 0 === t ? void 0 : t.vl) === i)
       return this.Ge.pl;
     const n = new Ei(i);
     return (this.Ge = { vl: i, pl: n }), n;
   }
   ml() {
     var t, i, n;
     return null !==
 ...
 class Ni {
   ...
   gt() {
     return (
       this.Wt.J(Object.assign({ ji: this.wl.ji() }, Li(this.bl))), this.Wt
     );
   }
 }
 class Fi extends J {
 ...
 class qi extends Ri {
   ...
   Lh(t) {
     ...
     void 0 !== i && i !== this._n.priceScaleId && this.$t().Hl(this, i),
       C(this._n, t),
       void 0 !== t.priceFormat && (this.Nl(), this.$t().$l()),
       this.$t().Ul(this),
       this.$t().ql(),
       this.mn.bt("options");
   }
   J(t, i) {
     this.Et.J(t),
       ...
       this.un.bt("data"),
       null !== this.Al &&
         (i && i.Xl ? this.Al.Wr() : 0 === t.length && this.Al.Fr());
   ...
   Ct() {
     const t = this.ta();
     return null === t ? null : { Ot: t.Ot[3], ia: t.ot };
   }
   ta() {
   ...
   Rn() {
     ...
     this.Eh.bt(),
       this.Ol.bt(),
       null === (t = this.Al) || void 0 === t || t.bt(),
       this.Il.forEach((t) => t.Rn());
   }
   Dt() {
     return f(super.Dt());
   }
     ...
     if (this.ft) {
       const t = this.Qi.$t().W().grid,
         i = {
           ...
           Ea: this.Qi.dn().Ia(),
           Oa: (this.Qi.$t().St().Ia() || []).map((t) => ({ Aa: t.coord })),
         };
 ...
 class an {
   ...
   Ha(t, i, n) {
     ...
     if (
       ...
       for (r = 0, h = this.ja[0]; Mt(e, n * h, 1e-14) && e > s + 1e-14; )
 ...
 class fn {
   constructor(t, i, n, s) {
     (this.Qa = 0),
       ...
       (this.mo = n),
       (this.bo = s),
       (this.wo = new on(this, 100, this.Mo.bind(this), this.xo.bind(this)));
   }
   xa() {
     return this.po;
   }
   ...
   Lh(t) {
     if (
       (C(this._n, t),
       this.Sa(),
       void 0 !== t.mode && this.So({ Sr: t.mode }),
     ...
     void 0 !== t.Nn && (this._n.autoScale = t.Nn),
       ...
       1 === i.Sr &&
         ...
         (!(function (t, i) {
           ...
           ? (this._n.autoScale = !0)
           : ((n = hn(this.Rh, this.vo)), null !== n && this.Po(n))),
       1 === t.Sr &&
         t.Sr !== i.Sr &&
         ((n = rn(this.Rh, this.vo)), null !== n && this.Po(n));
     const s = i.Sr !== this._n.mode;
     s && (2 === i.Sr || this.fh()) && this.Sa(),
       s && (3 === i.Sr || this.Co()) && this.Sa(),
       void 0 !== t.To &&
         i.To !== t.To &&
   ...
   Rt(t, i) {
     return (
       this.fh() ? (t = Ji(t, i)) : this.Co() && (t = tn(t, i)), this.xo(t, i)
     );
   }
   Gs(t, i, n) {
     this.zo();
   ...
   jo(t) {
     ...
     this._o.splice(i, 1),
       0 === this._o.length && (this.So({ Nn: !0 }), this.Po(null)),
       this.Sa(),
       this.Wo();
   }
   Ct() {
   ...
   Uo(t) {
     this.fh() ||
       ...
       (null === this.do &&
         null === this.no &&
         (this.Li() ||
           ((this.do = this.Qa - t), (this.no = f(this.Oh()).Mh()))));
   }
   qo(t) {
     ...
     (i = Math.max(i, 0.1)), n.kh(i), this.Po(n);
   }
   Yo() {
   ...
   Xo(t) {
     this.ko() ||
       (null === this.fo &&
         null === this.no &&
         (this.Li() || ((this.fo = t), (this.no = f(this.Oh()).Mh()))));
   }
   Ko(t) {
     if (this.ko()) return;
   ...
   Sa() {
     ...
     null !== t && (i = Math.round(1 / t.ua())),
       ...
       this.fh()
         ? ((this.da = cn), (i = 100))
         : this.Co()
         ? ((this.da = new _t(100, 1)), (i = 100))
         : null !== t && (this.da = t.ca()),
       (this.wo = new on(this, i, this.Mo.bind(this), this.xo.bind(this))),
       this.wo.Xa();
   }
   Wo() {
     this.uo = null;
   ...
   Bo() {
     return this.To()
       ? this._n.scaleMargins.bottom * this.Vt() + this.lo
       : this._n.scaleMargins.top * this.Vt() + this.ho;
   }
   Vo() {
     return this.To()
       ? this._n.scaleMargins.top * this.Vt() + this.ho
   ...
   i_() {
     ...
     if (
       ...
       null === this.Rh && (this.Po(new yi(-0.5, 0.5)), (this.vo = ln(null)));
     var r, h;
     this.so.eo = !0;
   }
   Io() {
 ...
 class vn {
   ...
   c_(t) {
     if (
       (t.leftPriceScale && this.a_.Lh(t.leftPriceScale),
       t.rightPriceScale && this.__.Lh(t.rightPriceScale),
   ...
   dn() {
     let t = null;
     return (
       this.Hi.W().rightPriceScale.visible && 0 !== this.__.Ta().length
         ? (t = this.__)
         : this.Hi.W().leftPriceScale.visible && 0 !== this.a_.Ta().length
         ? (t = this.a_)
         : 0 !== this._o.length && (t = this._o[0].Dt()),
       null === t && (t = this.__),
       t
     );
   }
   ...
   A_(t) {
     const i = this.wl.qs();
     t.So({ Nn: !0 }), null !== i && t.t_(i), this.b_();
   }
   B_() {
   ...
   M_(t, i, n) {
     let s = this.d_(i);
     if (
       (null === s && (s = this.o_(i, this.Hi.W().overlayPriceScales)),
       this._o.push(t),
       !ht(i))
     ) {
 ...
 class wn {
   ...
   G_(t, i) {
     ...
     return (
       (null !== this.Ge && this.Ge.J_ === n) ||
         (this.Ge = { Ia: this.Q_(n), J_: n }),
       this.Ge.Ia
     );
   }
   Z_(t) {
 ...
 class gn {
   ...
   iu() {
     return null === this.tu
       ? null
       : new mn(Math.floor(this.tu.Rs()), Math.ceil(this.tu.ui()));
   }
   nu() {
     return this.tu;
   }
 ...
 class xn {
   ...
   Lh(t, i) {
     ...
     C(this._n, t),
       ...
       void 0 !== t.minBarSpacing &&
         this.Hi.Kn(null !== (n = t.barSpacing) && void 0 !== n ? n : this.mu),
       this.gu(),
       this.bu(),
       this.cu.m();
   }
   ...
   ju(t, i) {
     const n = this.Vu(t),
       ...
       e = s + i * (s / 10);
     this.Kn(e),
       this._n.rightBarStaysOnScroll || this.Zn(this.Iu() + (n - this.Vu(t)));
   }
   Uo(t) {
     this.fo && this.Zo(),
       null === this.do &&
         null === this.du &&
         (this.Li() || ((this.do = t), this.Hu()));
   }
   qo(t) {
   ...
   ec() {
     return this._n.fixLeftEdge && this._n.fixRightEdge && 0 !== this.ru.length
   ...
   hc() {
     ...
     return (
       ...
       i -
       1 +
       (this._n.fixLeftEdge ? this.e_ / this.mu : Math.min(2, this.ru.length))
     );
   }
   rc() {
   ...
   Nu(t) {
     ...
     return (
       void 0 === i &&
         ((i = new pn((t) => this.lc(t), this.N_)), this.lu.set(t.weight, i)),
       i.F_(t)
     );
   }
   lc(t) {
   ...
   sc(t) {
     const i = this.au;
     (this.au = t),
       bn(i.iu(), this.au.iu()) || this._u.m(),
       bn(i.nu(), this.au.nu()) || this.uu.m(),
       this.nc();
   }
   nc() {
     this.fu = null;
 ...
 class kn {
   constructor(t) {
     (this.ft = !0),
       (this.Ft = { kt: !1, O: "", _c: [], dc: "center", fc: "center" }),
 ...
 class An {
   constructor(t, i, n) {
     (this.bc = []),
       ...
       (this.N_ = n),
       (this.kc = new E(this)),
       (this.wl = new xn(this, i.timeScale, this._n.localization, n)),
       (this.vt = new rt(this, i.crosshair)),
       (this.Cc = new Yi(i.crosshair)),
       (this.Tc = new Cn(this, i.watermark)),
       this.Pc(),
       this.bc[0].p_(2e3),
       (this.Rc = this.Dc(0)),
       (this.Oc = this.Dc(1));
   ...
   Lh(t) {
     C(this._n, t),
       ...
       void 0 !== t.timeScale && this.wl.Lh(t.timeScale),
   ...
   Ic(t, i) {
     if ("left" === t) return void this.Lh({ leftPriceScale: i });
     if ("right" === t) return void this.Lh({ rightPriceScale: i });
     const n = this.Lc(t);
   ...
   Pc(t) {
     ...
     const n = void 0 === t ? this.bc.length - 1 : t,
       s = lt.ns();
     return s.In(n, { Ln: 0, Nn: !0 }), this.Ac(s), i;
   }
   k_(t, i, n) {
     t.k_(i, n);
   }
   ...
   Qc(t, i, n, s, e) {
     ...
     null !== o && (r = a.fn(i, o)),
       ...
       this.vt.xn(h, r, s),
       this.sa(),
       e || this.xc.m(this.vt.xt(), { x: t, y: i }, n);
   }
   td(t, i, n) {
     const s = n.dn(),
       e = s.Ct(),
     ...
     if (null !== h && null !== s && null !== e) {
       const i = h.Yr(r),
         ...
         _ =
           i &&
           (!(void 0 === n) || o) &&
           this.wl.W().shiftVisibleRangeOnNewBar;
       if (a && !_) {
         const i = t - r;
   ...
   Bt(t) {
     ...
     if (
       ...
       null === this.Sc || this.Sc.ks !== n || this.Sc.Cs !== i)
     )
       this.Sc = { ks: n, Cs: i, ud: new Map() };
     else {
 ...
 function En(t, i, n) {
   return i
     .replace(/yyyy/g, ((t) => ot(zn(t), 4))(t))
     .replace(/yy/g, ((t) => ot(zn(t) % 100, 2))(t))
     .replace(
       /MMMM/g,
       ((t, i) =>
 ...
 function Un(t, i) {
   ...
   for (let n = Hn.length - 1; n >= 0; --n)
     if (
       Math.floor(i.getTime() / Hn[n].Sd) !==
       Math.floor(t.getTime() / Hn[n].Sd)
     )
       return Hn[n].yd;
   return 0;
 }
 function qn(t) {
   ...
   return { kd: Math.round(n.getTime() / 1e3), Cd: i };
 }
 function Yn(t) {
 ...
 class Zn {
   ...
   key(t) {
     return "object" == typeof t && "kd" in t
       ? t.kd
   ...
   formatTickmark(t, i) {
     ...
     return (function (t, i, n) {
       ...
       const e =
         void 0 === t.Cd
           ? new Date(1e3 * t.kd)
           : new Date(Date.UTC(t.Cd.year, t.Cd.month - 1, t.Cd.day));
       return new Date(
         e.getUTCFullYear(),
         e.getUTCMonth(),
         e.getUTCDate(),
 ...
 class ms {
   ...
   Rf() {
     null !== this.Hd && clearTimeout(this.Hd),
       (this.jd = 0),
       (this.Hd = null),
       (this.$d = {
         nt: Number.NEGATIVE_INFINITY,
   ...
   Cf() {
     null !== this.qd && clearTimeout(this.qd),
       (this.Ud = 0),
       (this.qd = null),
       (this.Yd = {
         nt: Number.NEGATIVE_INFINITY,
   ...
   Qf(t) {
     ...
     rs() && i.addEventListener("mouseleave", this.pf),
       (this.Qd = !1),
       (this.Zd = gs(t)),
       this.rf && (this.rf(), (this.rf = null));
     {
   ...
   Of() {
     this.Df.addEventListener("mouseenter", this.Bf.bind(this)),
       this.Df.addEventListener("touchcancel", this.Af.bind(this));
     {
       const t = this.Df.ownerDocument,
         i = (t) => {
           this.kf.iv &&
             ((t.composed && this.Df.contains(t.composedPath()[0])) ||
               (t.target && this.Df.contains(t.target)) ||
               this.kf.iv());
         };
       (this.nf = () => {
   ...
   lv(t) {
     1 === t.length && (this._f = !1),
       2 !== t.length || this._f || this.Kd ? this.av() : this.ov(t);
   }
   ov(t) {
     ...
     (this.lf = {
       ...
       (this.af = bs(t[0], t[1])),
       void 0 !== this.kf.ev && this.kf.ev(),
       this.Af();
   }
   av() {
     null !== this.lf &&
       ((this.lf = null), void 0 !== this.kf.hv && this.kf.hv());
   }
   nv(t) {
   ...
   gf(t, i) {
     const n = i || t,
       s = this.Df.getBoundingClientRect() || { left: 0, top: 0 };
     return {
       clientX: n.clientX,
       clientY: n.clientY,
       pageX: n.pageX,
 ...
 function Ss(t) {
   return { Ec: t.Ec, mv: { mr: t.bv.externalId }, wv: t.bv.cursorStyle };
 }
 function ys(t, i, n) {
   for (const s of t) {
     const t = s.gt();
 ...
 function ks(t, i) {
   return (n) => {
     var s, e, r, h;
     return (null !==
       (e = null === (s = n.Dt()) || void 0 === s ? void 0 : s.xa()) &&
     void 0 !== e
       ? e
       : "") !== i
       ? []
 ...
 class Cs {
   constructor(t, i, n, s) {
     (this.Ei = null),
       ...
       (this.Bv = us(this.Av, Gn({ width: 16, height: 16 }))),
     ...
     (e.style.position = "absolute"),
       ...
       (e.style.left = "0"),
       (e.style.top = "0"),
       (this.Vv = us(this.Av, Gn({ width: 16, height: 16 }))),
   ...
   S() {
     this.jv.S(),
       this.Vv.unsubscribeSuggestedBitmapSizeChanged(this.Tv),
       cs(this.Vv.canvasElement),
       this.Vv.dispose(),
       this.Bv.unsubscribeSuggestedBitmapSizeChanged(this.kv),
       cs(this.Bv.canvasElement),
       this.Bv.dispose(),
       null !== this.Ei && this.Ei.$o().p(this),
       (this.Ei = null);
   }
   Hv() {
     return this.Av;
   ...
   Gv(t) {
     ...
     if (1 !== t) {
       ...
       null !== t &&
         ...
         this.Qi.tp(t, this.Ov),
         this.ip(t),
         this.Qi.tp(t, this.Rv),
         this.np(t));
     }
   ...
   Ae({ context: t, bitmapSize: i, horizontalPixelRatio: n }) {
     if (null === this.gv || null === this.Ei || !this.Ei.W().borderVisible)
       return;
         ...
         (t.font = this.qv()),
           (t.fillStyle =
             null !== (r = n.textColor) && void 0 !== r
               ? r
               : this.mo.textColor),
           (t.textAlign = this.Pv ? "right" : "left"),
           (t.textBaseline = "middle");
 ...
 class Os {
   constructor(t, i) {
     (this.gv = Gn({ width: 0, height: 0 })),
       ...
       (this.Mp = t),
       (this.gp = i),
       this.gp.z_().l(this.xp.bind(this), this, !0),
     ...
     (n.style.width = "100%"),
       ...
       this.Sp.appendChild(n),
       (this.Bv = us(n, Gn({ width: 16, height: 16 }))),
       this.Bv.subscribeSuggestedBitmapSizeChanged(this.kv);
     ...
     (s.style.position = "absolute"),
       ...
       (s.style.left = "0"),
       (s.style.top = "0"),
       (this.Vv = us(n, Gn({ width: 16, height: 16 }))),
       this.Vv.subscribeSuggestedBitmapSizeChanged(this.Tv);
   ...
   S() {
     null !== this.ap && this.ap.S(),
       ...
       cs(this.Bv.canvasElement),
       this.Bv.dispose(),
       null !== this.gp && this.gp.z_().p(this),
       this.jv.S();
   }
   Zv() {
     return f(this.gp);
   ...
   Pp(t) {
     null !== this.gp && this.gp.z_().p(this),
       (this.gp = t),
       null !== this.gp &&
         this.gp.z_().l(Os.prototype.xp.bind(this), this, !0),
       this.Tp();
   }
   Cv() {
     return this.Mp;
   ...
   Ef(t) {
     ...
     const e = this.pr(n, s);
     this.Mp.Vp(
       null !== (i = null == e ? void 0 : e.wv) && void 0 !== i ? i : null
     ),
       this.Hi().zc(e && { Ec: e.Ec, mv: e.mv });
   }
   Kf(t) {
   ...
   qf(t) {
     0 === this.Cv().W().trackingMode.exitMode && (this.mp = !0),
       this.Hp(),
       this.Lp(t);
   }
   pr(t, i) {
     ...
     return null === n
       ...
       : (function (t, i, n) {
           ...
           for (const r of s) {
             ...
             if (null !== s) return { Ec: r, vv: s.vv, mv: s.mv };
             if (
               e &&
               e.Ec === r &&
               "bottom" !== e.bv.zOrder &&
   ...
   $p(t, i) {
     f("left" === i ? this.ap : this.op).Xv(
       Gn({ width: t, height: this.gv.height })
     );
   }
   Up() {
     return this.gv;
   ...
   Gv(t) {
     ...
     if (
       (t > 1 && this.qp(),
       null !== this.ap && this.ap.Gv(t),
       null !== this.op && this.op.Gv(t),
       1 !== t)
     ) {
   ...
   Ep(t, i) {
     const n = i.localX,
       s = i.localY;
     t.M() && t.m(this.Hi().St().Bu(n), { x: n, y: s }, i);
   }
   Qv({ context: t, bitmapSize: i }) {
     const { width: n, height: s } = i,
       e = this.Hi(),
   ...
   Rp() {
     ...
     i ||
       null === this.ap ||
       (this.yp.removeChild(this.ap.Hv()), this.ap.S(), (this.ap = null)),
       n ||
         null === this.op ||
         (this.kp.removeChild(this.op.Hv()), this.op.S(), (this.op = null));
     const s = t.$t().ed();
     i &&
       null === this.ap &&
       ((this.ap = new Cs(this, t.W(), s, "left")),
       this.yp.appendChild(this.ap.Hv())),
       n &&
         null === this.op &&
         ((this.op = new Cs(this, t.W(), s, "right")),
         this.kp.appendChild(this.op.Hv()));
   }
   tm(t) {
   ...
   Ip(t) {
     ...
     const s = this.Mp.W(),
       ...
       r = s.kineticScroll;
     if (
       (!e.pressedMouseMove || t.cv) &&
       ((!e.horzTouchDrag && !e.vertTouchDrag) || !t.cv)
     )
       return;
     const h = this.gp.dn(),
       l = performance.now();
     if (
       ...
       if ((t.cv && r.touch) || (!t.cv && r.mouse)) {
         const t = n.ee();
         (this.wp = new _s(0.2 / t, 7 / t, 0.997, 15 / t)),
           this.wp.Fd(n.Iu(), this._p.kd);
       } else this.wp = null;
       h.Li() || i.P_(this.gp, h, t.localY), i.Xc(t.localX), (this.up = !0);
     }
     this.up &&
       (h.Li() || i.R_(this.gp, h, t.localY),
       i.Kc(t.localX),
       null !== this.wp && this.wp.Fd(n.Iu(), l));
   }
 }
 class As {
   constructor(t, i, n, s, e) {
 ...
 class Is {
   constructor(t, i) {
     (this.am = null),
       ...
       (this.Bv = us(this.pm, Gn({ width: 16, height: 16 }))),
       this.Bv.subscribeSuggestedBitmapSizeChanged(this.kv);
     ...
     (n.style.position = "absolute"),
       ...
       (n.style.left = "0"),
       (n.style.top = "0"),
       (this.Vv = us(this.pm, Gn({ width: 16, height: 16 }))),
       this.Vv.subscribeSuggestedBitmapSizeChanged(this.Tv);
   ...
   S() {
     this.jv.S(),
       null !== this.am && this.am.S(),
       null !== this.om && this.om.S(),
       this.Vv.unsubscribeSuggestedBitmapSizeChanged(this.Tv),
       cs(this.Vv.canvasElement),
       this.Vv.dispose(),
       this.Bv.unsubscribeSuggestedBitmapSizeChanged(this.kv),
   ...
   Xf() {
     this._m = !1;
     const t = this.Mp.$t();
     (t.St().Li() && !this.Mp.W().handleScale.axisPressedMouseMove.time) ||
       t.Jc();
   }
   qf() {
     this.Xf();
   ...
   xm(t, i, n) {
     Jn(this.gv, t) ||
       ...
       (this.Av.style.height = `${t.height}px`),
       this.um.m(t)),
       null !== this.am && this.am.Xv(Gn({ width: i, height: t.height })),
       null !== this.om && this.om.Xv(Gn({ width: n, height: t.height }));
   }
   Sm() {
     const t = this.ym();
   ...
   Gv(t) {
     ...
     if (1 !== t) {
       ...
       null !== i &&
         ...
         this.ip(i),
         this.Cm(i, Vs)),
         null !== this.am && this.am.Gv(t),
         null !== this.om && this.om.Gv(t);
     }
     this.Vv.applySuggestedBitmapSize();
     const i = ss(this.Vv);
     null !== i &&
   ...
   Rm(t, i, n) {
     ...
     return (
       r < 0
         ? (i += Math.abs(0 - r))
         : r + s > this.gv.width && (i -= Math.abs(this.gv.width - (r + s))),
       i
     );
   }
   Tm(t, i) {
 ...
 class Fs {
   constructor(t, i, n) {
     ...
     (this.Om = []),
       ...
       ((s = this.dm).style.userSelect = "none"),
       ...
       Ws(this._n) && this.Hm(!0),
       (this.Hi = new An(this.yc.bind(this), this._n, n)),
       this.$t().jc().l(this.$m.bind(this), this),
       (this.Um = new Is(this, this.N_)),
   ...
   S() {
     this.Hm(!1),
       0 !== this.Am && window.cancelAnimationFrame(this.Am),
       this.Hi.jc().p(this),
   ...
   Ym(t, i, n = !1) {
     ...
     const e = this.Qa + "px",
       r = this.e_ + "px";
     (f(this.dm).style.height = e),
       (f(this.dm).style.width = r),
       (this.Fm.style.height = e),
       (this.Fm.style.width = r),
       n ? this.Qm(lt.ns(), performance.now()) : this.Hi.$l();
   }
   Gv(t) {
     void 0 === t && (t = lt.ns());
   ...
   ib() {
     null !== this.zm &&
       (this.Qm(this.zm, performance.now()), (this.zm = null));
   ...
   tb(t) {
     (void 0 !== t.autoSize ||
       ...
       (t.autoSize && !this.Im && this.qm(),
       !1 === t.autoSize && null !== this.Im && this.Jm(),
       t.autoSize ||
         (void 0 === t.width && void 0 === t.height) ||
   ...
   nb(t) {
     ...
     if (this._n.timeScale.visible) {
       ...
       if (null !== t) {
         let e = 0;
         this.eb() && (r("left", e, n), (e = f(s.Gp()).ep().width)),
           this.Um.rp(t, e, n),
           (e += i.width),
           this.rb() && r("right", e, n);
       }
   ...
   _b() {
     ...
     for (let t = 0; t < this.Om.length; ++t) {
       ...
       let e = 0,
         h = 0;
       (h = t === this.Om.length - 1 ? _ - c : Math.round(s.v_() * u)),
         (e = Math.max(h, 2)),
         (c += e),
         s.Xv(Gn({ width: r, height: e })),
         this.eb() && s.$p(i, "left"),
         this.rb() && s.$p(n, "right"),
         s.Zv() && this.Hi.Hc(s.Zv(), e);
     }
     this.Um.xm(Gn({ width: h ? r : 0, height: l }), h ? i : 0, h ? n : 0),
       this.Hi.m_(r),
       this.Bm !== i && (this.Bm = i),
       this.Vm !== n && (this.Vm = n);
   }
   ...
   Qm(t, i) {
     ...
     3 === s && this.cb(),
       (3 !== s && 2 !== s) ||
         ...
         3 === (null === (n = this.zm) || void 0 === n ? void 0 : n.Fn()) &&
           (this.zm.Jn(t),
           this.cb(),
           this.fb(this.zm),
           this.vb(this.zm, i),
   ...
   yc(t) {
     null !== this.zm ? this.zm.Jn(t) : (this.zm = t),
       this.Em ||
         ((this.Em = !0),
         (this.Am = window.requestAnimationFrame((t) => {
   ...
   Xm() {
     ...
     for (let s = n; s < i; s++) {
       ...
       i.Wp().l(this.pb.bind(this), this),
         i.jp().l(this.mb.bind(this), this),
         this.Om.push(i),
         this.Fm.insertBefore(i.Hv(), this.Um.Hv());
     }
     for (let n = 0; n < i; n++) {
       const i = t[n],
         s = this.Om[n];
 ...
 function qs(t, i, n, s) {
   const e = { ie: i, ot: t, Ot: [n.open, n.high, n.low, n.close], wb: s };
 ...
 function Ys(t, i, n, s) {
   ...
   return (
     ...
     void 0 !== n.borderColor && (e.At = n.borderColor),
     void 0 !== n.wickColor && (e.Hh = n.wickColor),
     e
   );
 }
 function Xs(t, i, n, s, e) {
   const r = d(e)(n),
     ...
     _ = n,
     { time: u, color: c } = _;
   return { ie: i, ot: t, Ot: o, wb: s, We: js(_, ["time", "color"]), O: c };
 }
 function Ks(t) {
   return void 0 !== t.Ot;
 }
 ...
 function Qs(t) {
   return { ie: 0, Cb: new Map(), ia: t };
 }
 function te(t, i) {
   if (void 0 !== t && 0 !== t.length)
     return { Tb: i.key(t[0].ot), Pb: i.key(t[t.length - 1].ot) };
 }
 function ie(t) {
   let i;
   return (
 ...
 class ne {
   ...
   Bb(t, i) {
     ...
     if (void 0 !== e)
       ...
       else for (const i of this.Ab) i.pointData.Cb.delete(t) && (s = !0);
     let r = [];
     if (0 !== i.length) {
   ...
   Nb(t, i) {
     ...
     null === s || this.N_.key(i.ot) > this.N_.key(s.ot)
       ? Ks(i) && n.push(i)
       : Ks(i)
       ? (n[n.length - 1] = i)
       : n.splice(-1, 1),
   ...
   zb(t, i) {
     0 !== i.length
       ? (this.Db.set(t, i.filter(Ks)), this.Ob.set(t, i[i.length - 1].ot))
       : (this.Db.delete(t), this.Ob.delete(t));
   }
   Vb() {
     for (const t of this.Ab)
       0 === t.pointData.Cb.size && this.Rb.delete(this.N_.key(t.time));
   }
   Eb(t) {
     let i = -1;
   ...
   Ib(t, i, n) {
     const s = { Wb: new Map(), St: { Au: this.Fb() } };
     if (-1 !== i)
       this.Db.forEach((i, e) => {
         s.Wb.set(e, { We: i, jb: e === t ? n : void 0 });
       }),
         this.Db.has(t) || s.Wb.set(t, { We: [], jb: n }),
         (s.St.Hb = this.Ab),
         (s.St.$b = i);
     else {
       const i = this.Db.get(t);
       s.Wb.set(t, { We: i || [], jb: n });
     }
     return s;
   }
 }
 ...
 function ee(t) {
   const i = { value: t.Ot[3], time: t.wb };
 ...
 class ye {
   ...
   setMarkers(t) {
     this.N_;
     const i = t.map((t) =>
       Me(t, this.N_.convertHorzItemToInternal(t.time), t.time)
     );
     this.zs.Zl(i);
   }
   markers() {
 ...
 class Pe {
   ...
   fw(t) {
     ...
     i.sd(t.St.Au, t.St.Hb, t.St.$b),
       t.Wb.forEach((t, i) => i.J(t.We, t.jb)),
       i.zu();
   }
   pw(t) {
